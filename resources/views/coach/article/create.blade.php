        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Create New Article</h3>
                    <h6 class="font-weight-normal mb-0">Add a new article to the fitness platform</h6>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">This will be used to generate the URL slug
                                        automatically.</small>
                                </div>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('author_id') is-invalid @enderror"
                                                id="author_id" name="author_id" required disabled>
                                                <option value="">Select Author</option>
                                                @foreach ($authors as $author)
                                                    <option value="{{ $author->id }}"
                                                        {{ auth()->user()->id == $author->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-grid gap-2">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="ti-check"></i> Create Article
                                            </button>
                                ...
                                <div class="card-body">
                                    <div class="seo-preview">
                                        ...
                                        <div class="seo-description text-muted small" id="seoDescription">Article preview will appear here...</div>
                                    </div>
                                </div>
                            </div> --}}
                            </div>
