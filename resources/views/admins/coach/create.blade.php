...
<div class="content-wrapper">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            <h3 class="page-title">Create New Coach</h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('coach.store') }}" method="POST" enctype="multipart/form-data" id="coachForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror"
                                      ...
                                      placeholder="Tell us about the coach's experience and specialties...">{{ old('bio') }}</textarea>
                        ...
                        <div class="alert alert-info">
                            <i class="ti-info-alt"></i> Set the coach's regular availability schedule. This can be modified later by the coach.
                        </div>
                            ...
                            <div class="availability-day mb-3 p-3 rounded">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox"
                                           id="day_{{ $index }}"
                                           name="availability[{{ $index }}][0][enabled]"
                                           value="1">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-5">
                                                ...
                                                <input type="time" class="form-control"
                                                       name="availability[{{ $index }}][0][start_time]"
                                                       value="09:00">
                                            </div>
                                            <div class="col-md-5">
                                                <label class="form-label">End Time</label>
                                                <input type="time" class="form-control"
                                                       name="availability[{{ $index }}][0][end_time]"
                                                       value="17:00">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ti-check"></i> Create Coach
                            </button>
                        </div>
                    </form>
                </div>
