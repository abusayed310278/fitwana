...
<div class="content-wrapper">
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            <h3 class="page-title">Edit Nutritionist - {{ $nutritionist->name }} {{ $nutritionist->last_name }}</h3>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <div class="profile-photo-container">
                            <img src="{{ $nutritionist->profile_photo_url ?? asset('assets/images/faces/face28.jpg') }}" alt="profile"
                                class="profile-photo" id="photoPreview" onclick="document.getElementById('photoUpload').click();" />
                            <div class="remove-photo-btn" title="Remove photo" style="{{ $nutritionist->profile_photo_url ? 'display: flex;' : 'display: none;' }}">
                                <i class="ti-close"></i>
                            </div>
                        </div>
                    ...
                    {{-- Nutritionist Stats --}}
                    <div class="mt-4">
                        <h6 class="fw-bold">Nutritionist Statistics</h6>
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="border rounded p-2">
                                    <h5 class="mb-1 text-primary">{{ $nutritionist->articles->count() }}</h5>
                                    <small class="text-muted">Articles</small>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="border rounded p-2">
                                    <h5 class="mb-1 text-success">{{ $nutritionist->appointmentsAsCoach->count() }}</h5>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('nutritionist.update', $nutritionist) }}" method="POST" enctype="multipart/form-data" id="nutritionistForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="name" name="name" value="{{ old('name', $nutritionist->name) }}" required>
                                @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="last_name" class="form-label">Last Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                       id="last_name" name="last_name" value="{{ old('last_name', $nutritionist->last_name) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('display_name') is-invalid @enderror"
                                       id="display_name" name="display_name" value="{{ old('display_name', $nutritionist->display_name) }}" required>
                                @error('display_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="email" class="form-label">Email Address <span class="text-danger">*</span></label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                       id="email" name="email" value="{{ old('email', $nutritionist->email) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('whatsapp') is-invalid @enderror"
                                       id="whatsapp" name="whatsapp" value="{{ old('whatsapp', $nutritionist->whatsapp) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror"
                                      ...
                                      placeholder="Tell us about the nutritionist's specialties and experience...">{{ old('bio', $nutritionist->bio) }}</textarea>
                        ...
                        <div class="alert alert-info">
                            <i class="ti-info-alt"></i> Update the nutritionist's regular availability schedule. This can be modified later by the nutritionist.
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="availability-day mb-3 p-3 rounded">
                                @php
                                    ...
                                    // Default fallback
                                    $isChecked = $daySlots->isNotEmpty();
                                    $startTime = $daySlots->first()->start_time ?? '09:00';
                                    $endTime = $daySlots->first()->end_time ?? '17:00';
                                @endphp
                        ...
                        <div class="mb-4">
                            ...
                            <div id="blocked-times-container">
                                @php
                                    $blockedTimes = $nutritionist->availabilities->where('is_blocked', true);
                                    $blockedIndex = 0;
                                @endphp
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ti-check"></i> Update Nutritionist
                            </button>
                        </div>
                    </form>
                </div>
