...
namespace App\Http\Controllers\Coach\Content;
...
class ContentController extends Controller
{
    public function index()
    {
        ...
        return view('coach.content.index', compact('totalArticles', 'totalMealPlans', 'totalRecipes'));
    }

    // Article Management
    public function articleIndex()
    {
        return view('coach.content.articles.index');
    }

    public function articleCreate()
    {
        $authors = User::role(['admin', 'coach', 'nutritionist'])->get();
        return view('coach.content.articles.create', compact('authors'));
    }
    ...
    {
        return view('coach.content.recipes.index');
    }

    public function recipeCreate()
    {
        return view('coach.content.recipes.create');
    }
